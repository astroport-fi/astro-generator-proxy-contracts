...
export async function performTransaction_with_msgs(
...
export async function instantiateContract(
  ...
  return attributes[attributes.length - 2].value; // contract address
}
...
export async function deployContract(
  ...
  console.log(codeId);
  // await delay(42);
  return await instantiateContract(terra, wallet, codeId, initMsg, label, memo);
}
