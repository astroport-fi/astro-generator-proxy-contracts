...
const CONTRACT_NAME: &str = "astroport-generator-proxy-to-stt";
...
/// Stakes them with the Starterra LP Staking contract
fn receive_cw20(
    deps: DepsMut,
    _env: Env,
    info: MessageInfo,
...
/// @dev Claims pending rewards from the STT LP staking contract
...
/// @dev Transfers STT rewards
/// @param account : User to which STT tokens are to be transferred
/// @param amount : Number of STT to be transferred
fn send_rewards(
    deps: DepsMut,
    info: MessageInfo,
    account: Addr,
