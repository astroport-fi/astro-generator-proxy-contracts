...
The generator proxy contract interacts with the MIR token LP staking contract. LPs can receive both MIR and ASTRO rewards which is the dual rewards feature available on Astroport. The staking via proxy contract is [here](https://miro.medium.com/max/1400/0*8hn2NSnZJZTa9YGV).
