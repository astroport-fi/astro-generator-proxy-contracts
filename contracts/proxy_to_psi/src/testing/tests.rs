...
fn test_proper_initialization() {
    ...
    let msg = InstantiateMsg {
        ...
        lp_token_addr: "psiust0000".to_string(),
        reward_contract_addr: "reward0000".to_string(),
        reward_token_addr: "psi0000".to_string(),
    };
    ...
    assert_eq!("psiust0000", config.lp_token_addr.as_str());
    assert_eq!("reward0000", config.reward_contract_addr.as_str());
    assert_eq!("psi0000", config.reward_token_addr.as_str());
}
...
fn test_deposit() {
    ...
    assert_eq!(
        ...
        vec![SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
            contract_addr: "psiust0000".to_string(),
            funds: vec![],
            msg: to_binary(&Cw20ExecuteMsg::Send {
                contract: "reward0000".to_string(),
                amount: Uint128::from(100u128),
                msg: to_binary(&PsiCw20HookMsg::Bond {}).unwrap(),
            })
            .unwrap(),
        }))]
    );
...
fn test_update_rewards() {
    ...
    assert_eq!(
        ...
        vec![SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
            ...
            funds: vec![],
            msg: to_binary(&PsiExecuteMsg::Withdraw {}).unwrap(),
        }))]
    );
...
fn test_query_reward_info() {
    ...
    assert_eq!(query_res, Addr::unchecked("psi0000"));
}
