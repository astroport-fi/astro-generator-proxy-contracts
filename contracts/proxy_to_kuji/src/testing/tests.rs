...
fn test_proper_initialization() {
    ...
    let msg = InstantiateMsg {
        ...
        lp_token_addr: "kujiust0000".to_string(),
        reward_contract_addr: "reward0000".to_string(),
        reward_token_addr: "kuji0000".to_string(),
    };
    ...
    assert_eq!("kujiust0000", config.lp_token_addr.as_str());
    assert_eq!("reward0000", config.reward_contract_addr.as_str());
    assert_eq!("kuji0000", config.reward_token_addr.as_str());
}
...
fn test_deposit() {
    ...
    let info = mock_info("kujiust0000", &[]);
    let deposit_msg = ExecuteMsg::Receive(Cw20ReceiveMsg {
...
fn test_send_rewards() {
    ...
    assert_eq!(
        res.messages,
        vec![SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
            contract_addr: "kuji0000".to_string(),
...
fn test_query_reward_info() {
    ...
    assert_eq!(query_res, Addr::unchecked("kuji0000"));
}
